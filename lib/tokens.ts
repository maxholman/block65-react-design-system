...
export const defaultTextTokens = {
  capSize: {
    '00': {
      fontSize: '12.375px',
      lineHeight: 'normal',
      capHeightTrim: '-0.2415em',
      baselineTrim: '-0.2415em',
    },
    '0': {
      fontSize: '13.75px',
      lineHeight: 'normal',
  ...
  size: {
    '00': { fontSize: '12px', lineHeight: 'initial' },
    '0': { fontSize: '14px', lineHeight: 'initial' },
    '1': { fontSize: '16px', lineHeight: 'initial' },
    '2': { fontSize: '20px', lineHeight: 'initial' },
    '3': { fontSize: '22px', lineHeight: 'initial' },
    '4': { fontSize: '25px', lineHeight: 'initial' },
    '5': { fontSize: '35px', lineHeight: 'initial' },
    '6': { fontSize: '42px', lineHeight: 'initial' },
    body: { fontSize: '16px', lineHeight: 'initial' },
    small: { fontSize: '14px', lineHeight: 'initial' },
  },
